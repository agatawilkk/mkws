...
clc;clear all; close;
filenamea = 'CH(X)-partition.csv';
filenameb = 'CH(A)-partition.csv';
filenamec = 'CH-partition.csv';
filenamed = 'CH-cantera.csv';
row_start = 11;
...
str_1 = ['CH(X)'];
str_2 = ['CH(A)'];
str_3 = ['CH (First 6 states)'];
str_4 = ['CH (NASA 20000 K fit))'];
